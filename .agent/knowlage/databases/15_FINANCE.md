# 15. FINANCE DATABASES

## 15.1. Master Data & Billing

### 15.1.1. Tabel `finance_coa` (Chart of Accounts)
...
### 15.1.2. Tabel `finance_fee_types` (Komponen Biaya)
...
### 15.1.3. Tabel `finance_invoices` (Header Tagihan)
...
### 15.1.4. Tabel `finance_invoice_items` (Detail Tagihan)
...
## 15.2. Wallet & Transactions (Inti Transaksi)

### 15.2.1. Tabel `finance_wallets` (Dompet Santri)
...
### 15.2.2. Tabel `finance_wallet_transactions` (Mutasi Dompet)
...
### 15.3.1. Tabel `finance_payment_methods` (Konfigurasi)
...
### 15.3.2. Tabel `finance_gateway_transactions` (Log Pembayaran Masuk)
...
## 15.4. Accounting (Buku Besar)

### 15.4.1. Tabel `finance_journals` (Jurnal Umum Header)
...
### 15.4.2. Tabel `finance_journal_details` (Baris Jurnal)
...
### 15.4.3. Tabel `finance_fixed_vas` (Virtual Account Tetap)
...
### 15.4.4. Logic Alur Pembayaran (Payment Flow)
