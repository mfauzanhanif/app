...
/**
* @see \Modules\User\Http\Controllers\PermissionController::assignToRole
 ...
 */
export const assignToRole = (args: { institution: string | number, role: string | number } | [institution: string | number, role: string | number ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: assignToRole.url(args, options),
    method: 'post',
})

assignToRole.definition = {
    methods: ["post"],
 ...
 * @route '//app.daraltauhid.test/{institution}/roles/{role}/permissions'
 */
assignToRole.url = (args: { institution: string | number, role: string | number } | [institution: string | number, role: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    institution: args[0],
                    role: args[1],
    ...
    return assignToRole.definition.url
            .replace('{institution}', parsedArgs.institution.toString())
 ...
 * @route '//app.daraltauhid.test/{institution}/roles/{role}/permissions'
 */
assignToRole.post = (args: { institution: string | number, role: string | number } | [institution: string | number, role: string | number ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: assignToRole.url(args, options),
    method: 'post',
})
 ...
 * @route '//app.daraltauhid.test/{institution}/roles/{role}/permissions'
 */
    const assignToRoleForm = (args: { institution: string | number, role: string | number } | [institution: string | number, role: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: assignToRole.url(args, options),
        method: 'post',
    })
 ...
 * @route '//app.daraltauhid.test/{institution}/roles/{role}/permissions'
 */
        assignToRoleForm.post = (args: { institution: string | number, role: string | number } | [institution: string | number, role: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: assignToRole.url(args, options),
            method: 'post',
        })
    
    assignToRole.form = assignToRoleForm
const PermissionController = { index, create, store, show, edit, update, destroy, assignToRole }
