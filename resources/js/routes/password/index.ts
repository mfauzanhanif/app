 ...
 * @route '//app.daraltauhid.test/forgot-password'
 */
...
request.definition = {
    methods: ["get","head"],
    url: '//app.daraltauhid.test/forgot-password',
 ...
 * @route '//app.daraltauhid.test/reset-password/{token}'
 */
...
reset.definition = {
    methods: ["get","head"],
    url: '//app.daraltauhid.test/reset-password/{token}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '//app.daraltauhid.test/reset-password'
 */
...
update.definition = {
    methods: ["post"],
    url: '//app.daraltauhid.test/reset-password',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '//app.daraltauhid.test/user/confirm-password'
 */
...
confirm.definition = {
    methods: ["get","head"],
    url: '//app.daraltauhid.test/user/confirm-password',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '//app.daraltauhid.test/user/confirmed-password-status'
 */
...
confirmation.definition = {
    methods: ["get","head"],
    url: '//app.daraltauhid.test/user/confirmed-password-status',
} satisfies RouteDefinition<["get","head"]>
