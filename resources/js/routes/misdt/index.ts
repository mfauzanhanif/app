 ...
 */
    ...
    bio.form = bioForm
const misdt = {
    beranda: Object.assign(beranda, beranda),
profil: Object.assign(profil, profil),
program: Object.assign(program, program),
fasilitas: Object.assign(fasilitas, fasilitas),
ppdb: Object.assign(ppdb, ppdb),
kontak: Object.assign(kontak, kontak),
bio: Object.assign(bio, bio),
}

export default misdt