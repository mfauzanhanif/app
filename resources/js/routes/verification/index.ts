 ...
 * @route '//app.daraltauhid.test/email/verify'
 */
...
notice.definition = {
    methods: ["get","head"],
    url: '//app.daraltauhid.test/email/verify',
 ...
 * @route '//app.daraltauhid.test/email/verify/{id}/{hash}'
 */
...
verify.definition = {
    methods: ["get","head"],
    url: '//app.daraltauhid.test/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '//app.daraltauhid.test/email/verification-notification'
 */
...
send.definition = {
    methods: ["post"],
    url: '//app.daraltauhid.test/email/verification-notification',
