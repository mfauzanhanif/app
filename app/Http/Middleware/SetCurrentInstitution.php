...
class SetCurrentInstitution
{
    ...
    {
        // Default binding to null to prevent "Binding not found" error
        ...
        if ($institution) {
            ...
            // 4. Set Spatie Permissions Team ID (Global Context for this Request)
        ...
        if (! $institutionParam) {
            ...
            app()->instance('current_institution', null);
            // Reset Spatie Team ID to null (Global/Admin context or No Context)
