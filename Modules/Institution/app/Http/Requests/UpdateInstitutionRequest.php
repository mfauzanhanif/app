...
class UpdateInstitutionRequest extends FormRequest
{
    ...
    {
        $id = is_object($this->route('institution')) ? $this->route('institution')->id : $this->route('institution');

        return [
            'code' => ['required', 'string', 'max:20', Rule::unique('institutions', 'code')->ignore($id)],
            'slug' => ['required', 'string', 'max:100', Rule::unique('institutions', 'slug')->ignore($id)],
            'domain' => ['nullable', 'string', 'max:100', Rule::unique('institutions', 'domain')->ignore($id)],
