    ...
    public function up(): void
    {
        ...
        Schema::create('assets', function (Blueprint $table) {
            ...
            $table->enum('status', [
                ...
                'hilang',         // Hilang (tunggu keputusan audit)
                'dijual',      // Sudah dihapus/dijual
            ])->default('aktif');
        ...
        Schema::create('asset_lendings', function (Blueprint $table) {
            ...
            $table->enum('status', ['diajukan', 'disetujui', 'dipinjam', 'dikembalikan', 'ditolak'])
                ->default('diajukan');
        ...
        Schema::create('asset_maintenances', function (Blueprint $table) {
            ...
            $table->enum('status', ['diajukan', 'disetujui', 'diperbaiki', 'selesai', 'tidak_diperbaiki'])
                  ->default('diajukan');
        ...
        Schema::create('stock_opname_items', function (Blueprint $table) {
            ...
            $table->enum('actual_status', ['baik', 'rusak_ringan', 'rusak_berat']);
        ...
        Schema::create('asset_disposals', function (Blueprint $table) {
            ...
            $table->enum('reason', ['rusak_berat', 'hilang', 'dijual', 'dikirim']);
